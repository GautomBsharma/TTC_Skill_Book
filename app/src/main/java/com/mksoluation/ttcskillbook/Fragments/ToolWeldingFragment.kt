...
import com.mksoluation.ttcskillbook.databinding.FragmentToolWeldingBinding

class ToolWeldingFragment : Fragment() {
    private lateinit var binding: FragmentToolWeldingBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentToolWeldingBinding.inflate(layoutInflater)
        auth = FirebaseAuth.getInstance()
        val uid = auth.currentUser?.uid
        toolList = ArrayList()
        binding.recyclerSignalwel.layoutManager = LinearLayoutManager(requireContext())
