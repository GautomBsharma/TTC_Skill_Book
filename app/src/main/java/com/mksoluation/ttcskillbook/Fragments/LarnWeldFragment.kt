...
import com.mksoluation.ttcskillbook.databinding.FragmentLarnWeldBinding


class LarnWeldFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentLarnWeldBinding.inflate(layoutInflater)
    ...
    private fun gettool() {
        val reff = FirebaseDatabase.getInstance().reference.child("Learn").child("Welding")
